"""API client for hcaptchasolver.com remote-session (createTask, start, next-action, screenshot, solved)."""
...
class RemoteSessionApiClient:
    """Client for the captcha-platform remote-session API."""
